...
function fn_process_pay_order(){
    ...
    console.log("사용 포인트 확인 :" + i_use_point.value);
    console.log("전체 포인트 확인 :" + i_total_point.value);
...
function fn_point() {
	...
	console.log("최종가격 : "+h_final_total_Price.value);
		...
		<tbody align=center>
			...
			<tr>
				<c:forEach var="item" items="${myOrderList }">
					...
					<td><h2>${total_delivery_price}원</h2></td>
			...
			<c:set var="total_Point" value="${total_point+1500 *item.order_goods_qty}"/>
			</c:forEach>
...
<%-- 				<tr class="dot_line">
					<td>현재 포인트</td>
					<td cellpadding="5"><input name="use_point" class="use_point" type="text"
						size="10"  />원<span class="point" name="point" value="${memberInfo.point}">${memberInfo.point}</span>원 사용가능 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두사용하기</td> <input type="button" onclick="fn_point_spend()" value="포인트사용">
